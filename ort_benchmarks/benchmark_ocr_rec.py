#!/usr/bin/env python3
"""
OCR Recognition 모델의 순수 ONNX Runtime 추론 성능 측정 스크립트
...
def benchmark_ocr_rec_ort():
    """OCR Recognition 모델의 ONNX Runtime 추론 성능 측정"""
    
    # =========================================================================
    # 모델 경로 설정
    # =========================================================================
    project_root = Path(__file__).parent.parent.absolute()
    ocr_rec_model_path = project_root / "onnx_models" / "ch_PP-OCRv5_rec_server_infer.onnx"
    ...
    logger.info("=" * 80)
    logger.info("OCR Recognition 모델 순수 ONNX Runtime 추론 성능 측정")
    logger.info("=" * 80)
